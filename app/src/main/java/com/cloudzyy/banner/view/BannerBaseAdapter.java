package com.cloudzyy.banner.view;
...
public abstract class BannerBaseAdapter<T> extends PagerAdapter {
    ...
    protected BannerBaseAdapter setImage(int viewId, String url) {
        ImageView iv = getView(viewId);
        //ImageLoader.getInstance(GlideApp.with(mContext)).defaultLoad(url).into(iv);
        return this;
    }
